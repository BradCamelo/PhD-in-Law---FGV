...
Coleta automática de dados via APIs públicas:
    - Lista de municípios da Paraíba (IBGE Localidades API)
    - População Censo 2022 (IBGE SIDRA Tabela 9514)
    - Receita Corrente e Despesa Corrente 2022 (SICONFI API — FINBRA)
    - IDHM 2010 (IPEADATA API)
    - Coordenadas + Distância rodoviária até João Pessoa (OSRM API)
